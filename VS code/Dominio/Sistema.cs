...
namespace PrimerObligatorio
{
    public class Sistema
    {
        ...
        public void GeneracionPeriodista(string nombrePeriodista, string apellidoPeriodista, string email, string password)
        {
            try
            {
        ...
        public List<Partido> GetPartidoConMasGoles(string seleccion)
        {
            ...
            foreach (Partido item in GetPartidosDeSeleccion(seleccion))
            {
                ...
                {
                    if (GetJugadorSegunId(item2.JugadorId).PaisJugador.NombrePais == seleccion && item2.Hecho == TipoIncidencia.Gol
                        && item2.Minuto != -1)
                    {
                        goles += 1;
                    }
                ...
                else if (goles > golesMaximos)
                {
                    golesMaximos = goles;
                    _ret.Clear();
                    //si los goles realizados superan a los registrados entonces se vacia la lista (es lista para considerar si existen partidos con 
        ...
        private void Precarga()
        {
            try
            {
                ...
                Periodista Periodista1 = new Periodista("Joaquin", "Cardozo", "jc@gmail.com", "123456789");
                AltaPeriodista(Periodista1);

                Periodista Periodista2 = new Periodista("Javier", "Fernandez", "jf@gmail.com", "123456789");
                AltaPeriodista(Periodista2);

                Periodista Periodista3 = new Periodista("Andres", "Fernandez", "af@gmail.com", "123456789");
                AltaPeriodista(Periodista3);

                //CREACION DE OPERADOR
                Operador Operador1 = new Operador("Emanuel", "Gonzalez", "eg@gmail.com", "123456789", new DateTime(2012, 11, 10));
                Usuarios.Add(Operador1);
                Operador Operador2 = new Operador("Gonzalo", "Fernandez", "gf@gmail.com", "123456789", new DateTime(2011, 11, 10));
                ...
                FaseGrupo partido1A = new FaseGrupo(new DateTime(2022, 11, 21, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido1A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Argentina"), GetSeleccionParaPartido("Catar"));
                AltaPartido(partido1A);

                FaseGrupo partido2A = new FaseGrupo(new DateTime(2022, 11, 22, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido2A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Argentina"), GetSeleccionParaPartido("Alemania"));
                AltaPartido(partido2A);

                FaseGrupo partido3A = new FaseGrupo(new DateTime(2022, 11, 23, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido3A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Alemania"), GetSeleccionParaPartido("Dinamarca"));
                AltaPartido(partido3A);

                FaseGrupo partido4A = new FaseGrupo(new DateTime(2022, 11, 24, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido4A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Catar"), GetSeleccionParaPartido("Alemania"));
                AltaPartido(partido4A);

                FaseGrupo partido5A = new FaseGrupo(new DateTime(2022, 11, 25, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido5A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Catar"), GetSeleccionParaPartido("Dinamarca"));
                AltaPartido(partido5A);

                FaseGrupo partido6A = new FaseGrupo(new DateTime(2022, 11, 26, 18, 00, 00), ClasificacionFaseGrupo.A);
                partido6A.AgregarSeleccionesPartido(GetSeleccionParaPartido("Argentina"), GetSeleccionParaPartido("Dinamarca"));
                AltaPartido(partido6A);

                //   ---->  Fase B

                FaseGrupo partido1B = new FaseGrupo(new DateTime(2022, 11, 21, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido1B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Brasil"), GetSeleccionParaPartido("Croacia"));
                AltaPartido(partido1B);

                FaseGrupo partido2B = new FaseGrupo(new DateTime(2022, 11, 22, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido2B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Francia"), GetSeleccionParaPartido("Bélgica"));
                AltaPartido(partido2B);

                FaseGrupo partido3B = new FaseGrupo(new DateTime(2022, 11, 23, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido3B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Bélgica"), GetSeleccionParaPartido("Croacia"));
                AltaPartido(partido3B);

                FaseGrupo partido4B = new FaseGrupo(new DateTime(2022, 11, 24, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido4B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Francia"), GetSeleccionParaPartido("Croacia"));
                AltaPartido(partido4B);

                FaseGrupo partido5B = new FaseGrupo(new DateTime(2022, 11, 25, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido5B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Brasil"), GetSeleccionParaPartido("Francia"));
                AltaPartido(partido5B);

                FaseGrupo partido6B = new FaseGrupo(new DateTime(2022, 11, 26, 14, 00, 00), ClasificacionFaseGrupo.B);
                partido6B.AgregarSeleccionesPartido(GetSeleccionParaPartido("Brasil"), GetSeleccionParaPartido("Bélgica"));
                AltaPartido(partido6B);

                //   ---->  Fase Octavos de Final

                FaseEliminatoria partido1SF = new FaseEliminatoria(new DateTime(2022, 11, 27, 13, 30, 00), true, ClasificacionFaseEliminatoria.Octavos);
                partido1SF.AgregarSeleccionesPartido(GetSeleccionParaPartido("Brasil"), GetSeleccionParaPartido("Argentina"));
                AltaPartido(partido1SF);

                FaseEliminatoria partido2SF = new FaseEliminatoria(new DateTime(2022, 11, 27, 18, 30, 00), true, ClasificacionFaseEliminatoria.Octavos);
                partido2SF.AgregarSeleccionesPartido(GetSeleccionParaPartido("Francia"), GetSeleccionParaPartido("Alemania"));
                ...
                foreach (Partido item in GetPartidos())
                {
                    if (item.IdPartido % 2 == 0 || item.IdPartido % 3 == 0 || item.IdPartido % 5 == 0)
                    {
                        item.FinalizacionPartido();
                    }
                }

                Reseña R1 = new Reseña(Periodista1, partido1A, "LA QUE PRIMERO SALIÓ CAMPEONA", "Si bien nosotros conocemos el potencial que ensta. Sino más ", new DateTime(2022, 12, 01));
                AltaResena(R1);

                Reseña R2 = new Reseña(Periodista1, partido2SF, "Union Berlín resiste en el liderato de la Bundesliga", "Aferrado a la épica, con u ventaja cuando el suizo Nico Elvedi batió a Frederik Ronnow tras recibir un balón de Lars Stindl.Fischer movió el banquillo. Hizo tres cambios de una tacada. Sacó a Sven Michel, a Genki Haraguchi y a Christopher Trimmel a la hora de juego. Pero no logró empatar hasta el 79, cuando Nico Elvedi llevó a la red un centro de Lars Stindl.", new DateTime(2022, 12, 02));
                AltaResena(R2);

                Reseña R3 = new Reseña(Periodista1, partido1SF, "Union Berlín resiste en el liderato de la Bundesliga", "Aferrado a la épica, con una remontada cu", new DateTime(2022, 12, 03));
                AltaResena(R3);

                Reseña R4 = new Reseña(Periodista2, partido2SF, "Union Berlín resiste en el liderato de la Bundesliga", "Aferrado a la épica, con una remontada culmia los locales a la media a", new DateTime(2022, 12, 03));

                Reseña R5 = new Reseña(Periodista3, partido2SF, "Union Berlín resiste en el liderato de la Bundesliga", "Aferrado a la épica, con una remontada culminada en el minuto 97, ", new DateTime(2022, 12, 03));
                AltaResena(R5);
            }
            catch (Exception e)
            {
